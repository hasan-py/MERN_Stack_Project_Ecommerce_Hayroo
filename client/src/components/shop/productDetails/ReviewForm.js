...
const ReviewForm = (props) => {
	...
	const fetchData = async () => {
        try {
            let responseData = await getSingleProduct(data.singleProductDetail._id);
	...
	console.log(data, isAuthenticate());
  ...
  return (
    <Fragment>
    {
    	...
    	? 	<div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 bg-red-200 px-4 py-2 rounded">You already reviewed this product</div>
