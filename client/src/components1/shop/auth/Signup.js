...
const Signup = (props) => {
  ...
  const formSubmit = async ()=> {
    ...
    try {
        let responseData = await signupReq({name:data.name,email:data.email,password:data.password,cPassword:data.cPassword});
          ...
          <form className="space-y-4">
           { data.success ? alert(data.success,"green") : "" }
            <div className="flex flex-col">
              ...
              <input onChange={e=> setData({...data,success:false,error:{},name:e.target.value})} value={data.name} type="text" id="name" className={`${data.error.name ? "border-red-500" : ""} px-4 py-2 focus:outline-none border`} />
            ...
            <div className="flex flex-col">
              ...
              <input onChange={e=> setData({...data,success:false,error:{},email:e.target.value})} value={data.email} type="email" id="email" className={`${data.error.email ? "border-red-500" : ""} px-4 py-2 focus:outline-none border`} />
            ...
            <div className="flex flex-col">
              ...
              <input onChange={e=> setData({...data,success:false,error:{},password:e.target.value})} value={data.password} type="password" id="password" className={`${data.error.password ? "border-red-500" : ""} px-4 py-2 focus:outline-none border`} />
            ...
            <div className="flex flex-col">
              ...
              <input onChange={e=> setData({...data,success:false,error:{},cPassword:e.target.value})} value={data.cPassword} type="password" id="cPassword" className={`${data.error.cPassword ? "border-red-500" : ""} px-4 py-2 focus:outline-none border`} />
            ...
            <div onClick={e=> formSubmit()} style={{background: '#303031'}} className="px-4 py-2 text-white text-center cursor-pointer font-medium">Create an account</div>
          </form>
    </Fragment>
  )
}
