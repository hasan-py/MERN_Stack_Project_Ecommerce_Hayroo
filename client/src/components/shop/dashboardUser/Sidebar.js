...
const Sidebar = (props) => {
  ...
  return (
    <Fragment>
    	<div className="flex flex-col w-full hidden md:block space-y-4 md:w-3/12">
    		<div style={{background: '#303031'}} className="flex items-center space-x-2 shadow p-2 text-gray-100">
