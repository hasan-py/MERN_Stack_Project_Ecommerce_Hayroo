			            ...
			            <div className="userDropdownBtn hover:bg-gray-200 px-2 py-2 rounded-lg relative" title="Logout">
			              ...
			              <div className="userDropdown absolute right-0 mt-1 bg-gray-200 rounded">
			              	<li className="flex flex-col text-gray-700">
			              		<a onClick={e=> history.push('/user/dashboard')} className="flex space-x-1 py-2 px-8 hover:bg-gray-400">
			              		...
			              		<a className="flex space-x-1 py-2 px-8 hover:bg-gray-400">
			              		...
			              		<a onClick={e=> logout() } className="flex space-x-1 py-2 px-8 hover:bg-gray-400">
