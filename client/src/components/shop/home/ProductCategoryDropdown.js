          ...
          <div className="w-full flex flex-col">
            ...
            <div className="flex justify-between items-center">	
	            <div className="flex flex-col space-y-2  w-2/3 lg:w-2/4">
	              <label for="points" className="text-sm">Price (between 0 and 10$): <span className="font-semibold text-yellow-700">{range}.00$</span> </label>
	              <input className="slider" type="range" id="points" min="0" max="1000" step="10" onChange={e=> rangeHandle(e)} />
	            </div>
