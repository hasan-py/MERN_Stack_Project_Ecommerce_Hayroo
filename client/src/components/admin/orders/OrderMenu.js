			...
			<div className="col-span-1 flex items-center">
				<div className="flex flex-col space-y-4 md:flex-row md:justify-between md:items-center md:space-y-0 w-full">
					...
					<div style={{background: '#303031'}} className="relative rounded-full text-gray-100 text-sm font-semibold uppercase">
						...
						<div style={{background: '#303031'}} className={`${dropdown ? "" : "hidden"} absolute top-0 left-0 mt-12 rounded-lg overflow-hidden w-full md:w-32 flex flex-col z-10`}>
							<span className="px-4 py-2 hover:bg-black text-center cursor-pointer">All</span>
							<span className="px-4 py-2 hover:bg-black text-center cursor-pointer">Not processed</span>
							<span className="px-4 py-2 hover:bg-black text-center cursor-pointer">Shipped</span>
							<span className="px-4 py-2 hover:bg-black text-center cursor-pointer">Processing</span>
							<span className="px-4 py-2 hover:bg-black text-center cursor-pointer">Delivered</span>
							<span className="px-4 py-2 hover:bg-black text-center cursor-pointer">Cancelled</span>
						</div>
					</div>
					<div>
						<SearchFilter/>
