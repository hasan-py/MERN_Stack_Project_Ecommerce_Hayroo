...
const AdminSidebar = (props) => {
  ...
  return (
    <Fragment>
        ...
        <hr className="border-b border-gray-200" />
        <div className={`${location.pathname == "/admin/dashboard/products" ? "border-r-4 border-gray-800 bg-gray-100" : ""} hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}>
        ...
        <hr className="border-b border-gray-200" />
        <div className={`${location.pathname == "/admin/dashboard/orders" ? "border-r-4 border-gray-800 bg-gray-100" : ""} hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}>
        ...
        <hr className="border-b border-gray-200" />
        <div className={`${location.pathname == "/admin/dashboard/customers" ? "border-r-4 border-gray-800 bg-gray-100" : ""} hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}>
